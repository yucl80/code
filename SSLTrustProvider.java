...
public final class SSLTrustProvider extends java.security.Provider
{ 
 	/**
	 * 
	 */
	private static final long serialVersionUID = -7467051676096334305L;
	...
	{ 
		...
		{ 
 			Security.insertProviderAt(new SSLTrustProvider(), 2); 
	...
	{ 
		...
		{ 
 			throw new InvalidAlgorithmParameterException(SSLTrustProvider.NAME + " does not use ManagerFactoryParameters"); 
 		} 
